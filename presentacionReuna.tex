...
\pgfdeclareimage[width=4.5cm]{uva}{img/uva}
\pgfdeclareimage[width=4.5cm]{pasi}{img/pasi}
\pgfdeclareimage[width=3.0cm]{marinescu}{img/marinescu}
\pgfdeclareimage[width=3.5cm]{atlas}{img/atlas}
\pgfdeclareimage[width=5.0cm]{lhc}{img/lhc}
\pgfdeclareimage[width=5.0cm]{future}{img/future}
